...
DATASET_DIR = Path(__file__).resolve().parents[3] / 'datasets' / 'otto-parquet'
...
# OUTPUT_PATH = Path(__file__).resolve().parents[3] / 'datasets' / 'otto-recommender-system')
...
PARQUET_DIR = Path(__file__).resolve().parents[3] / 'datasets' / 'otto-parquet'
