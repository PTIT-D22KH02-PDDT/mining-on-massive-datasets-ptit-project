...
from src.core.constant import (
    ...
    PAIRS_24H_PARQUET_FILE, PAIRS_14D_BUY2BUY_PARQUET_FILE, TAIL_SIZE, ONE_DAY_IN_MS, CART_TYPE, ORDER_TYPE,
    FOURTEEN_DAY_IN_MS
)
...
class DataProcessor:
    ...
    def build_intermediate_pairs(self, df: DataFrame) -> None:
        ...
        pairs_24h = self._generate_pairs(df_tail, ONE_DAY_IN_MS)
        ...
        pairs_14d = self._generate_pairs(df_buys_tail, FOURTEEN_DAY_IN_MS)
